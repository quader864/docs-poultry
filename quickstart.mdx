---
title: "Quickstart: authenticate and make your first API call"
description: "Get started with the Poultry Farm Analytics API: create an account, obtain a JWT token, and make your first authenticated request to list flocks."
---
