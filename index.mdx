---
title: "Poultry Farm Analytics API documentation"
description: "Introduction to the Poultry Farm Analytics platform: flock management, inventory, IoT sensors, anomaly detection, and predictive analytics for farms."
---
